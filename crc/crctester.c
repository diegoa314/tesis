...
const unsigned long polynom = 0xc1acf;
const int direct = 1;
const unsigned long crcinit = 0xfffff;
...
const unsigned char string[] = {"\x1122aabb"};
//const unsigned char string[] = {"\x11\x22\xaa\xbb\x33\x44\xcc\xdd\x55\x66\xee\xff"};
