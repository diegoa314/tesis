//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-05-24 18:05:46
//--------------------------------------------------------------------------------
module top(
	input write_clk_p,
	input write_clk_n,
...
reg [19:0] tx_crc_next = 20'd597792;
wire tx_link_ready1;
wire tx_fifo_empty1;
...
reg tx_change_disp_clockdomainsrenamer_next_value0 = 1'd0;
reg tx_change_disp_clockdomainsrenamer_next_value_ce0 = 1'd0;
reg tx_fifo_re1_clockdomainsrenamer_next_value1 = 1'd0;
reg tx_fifo_re1_clockdomainsrenamer_next_value_ce1 = 1'd0;
reg tx_sop_clockdomainsrenamer_next_value2 = 1'd0;
reg tx_sop_clockdomainsrenamer_next_value_ce2 = 1'd0;
reg tx_idle_clockdomainsrenamer_next_value3 = 1'd0;
reg tx_idle_clockdomainsrenamer_next_value_ce3 = 1'd0;
reg tx_encoder_ready_clockdomainsrenamer_next_value4 = 1'd0;
reg tx_encoder_ready_clockdomainsrenamer_next_value_ce4 = 1'd0;
reg tx_fifo_ready_clockdomainsrenamer_next_value5 = 1'd0;
reg tx_fifo_ready_clockdomainsrenamer_next_value_ce5 = 1'd0;
reg tx_strobe_crc_clockdomainsrenamer_next_value6 = 1'd0;
reg tx_strobe_crc_clockdomainsrenamer_next_value_ce6 = 1'd0;
reg tx_eop_clockdomainsrenamer_next_value7 = 1'd0;
reg tx_eop_clockdomainsrenamer_next_value_ce7 = 1'd0;
...
assign asyncfifo_din = {zeros, din_h, din_g, din_f, din_e, din_d, din_c, din_b, din_a};
...
assign tx_link_ready0 = link_ready;
...
always @(*) begin
	tx_crc_next <= 20'd597792;
	tx_crc_next[0] <= (((((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[13]) ^ tx_crc_dat[15]) ^ tx_crc_dat[16]) ^ tx_crc_dat[18]) ^ tx_crc_dat[19]) ^ tx_crc_dat[20]) ^ tx_crc_dat[24]) ^ tx_crc_dat[25]) ^ tx_crc_dat[27]) ^ tx_crc_cur[0]) ^ tx_crc_cur[1]) ^ tx_crc_cur[3]) ^ tx_crc_cur[4]) ^ tx_crc_cur[6]) ^ tx_crc_cur[7]) ^ tx_crc_cur[8]) ^ tx_crc_cur[12]) ^ tx_crc_cur[13]) ^ tx_crc_cur[15]);
	tx_crc_next[1] <= (((((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[14]) ^ tx_crc_dat[15]) ^ tx_crc_dat[17]) ^ tx_crc_dat[18]) ^ tx_crc_dat[21]) ^ tx_crc_dat[24]) ^ tx_crc_dat[26]) ^ tx_crc_dat[27]) ^ tx_crc_dat[28]) ^ tx_crc_cur[0]) ^ tx_crc_cur[2]) ^ tx_crc_cur[3]) ^ tx_crc_cur[5]) ^ tx_crc_cur[6]) ^ tx_crc_cur[9]) ^ tx_crc_cur[12]) ^ tx_crc_cur[14]) ^ tx_crc_cur[15]) ^ tx_crc_cur[16]);
	tx_crc_next[2] <= (((((((((((tx_crc_dat[12] ^ tx_crc_dat[20]) ^ tx_crc_dat[22]) ^ tx_crc_dat[24]) ^ tx_crc_dat[28]) ^ tx_crc_dat[29]) ^ tx_crc_cur[0]) ^ tx_crc_cur[8]) ^ tx_crc_cur[10]) ^ tx_crc_cur[12]) ^ tx_crc_cur[16]) ^ tx_crc_cur[17]);
	tx_crc_next[3] <= (((((((((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[15]) ^ tx_crc_dat[16]) ^ tx_crc_dat[18]) ^ tx_crc_dat[19]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[23]) ^ tx_crc_dat[24]) ^ tx_crc_dat[27]) ^ tx_crc_dat[29]) ^ tx_crc_dat[30]) ^ tx_crc_cur[0]) ^ tx_crc_cur[3]) ^ tx_crc_cur[4]) ^ tx_crc_cur[6]) ^ tx_crc_cur[7]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[11]) ^ tx_crc_cur[12]) ^ tx_crc_cur[15]) ^ tx_crc_cur[17]) ^ tx_crc_cur[18]);
	tx_crc_next[4] <= (((((((((((((((((((((((tx_crc_dat[13] ^ tx_crc_dat[16]) ^ tx_crc_dat[17]) ^ tx_crc_dat[19]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[24]) ^ tx_crc_dat[25]) ^ tx_crc_dat[28]) ^ tx_crc_dat[30]) ^ tx_crc_dat[31]) ^ tx_crc_cur[1]) ^ tx_crc_cur[4]) ^ tx_crc_cur[5]) ^ tx_crc_cur[7]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[12]) ^ tx_crc_cur[13]) ^ tx_crc_cur[16]) ^ tx_crc_cur[18]) ^ tx_crc_cur[19]);
	tx_crc_next[5] <= (((((((((((((((((((((tx_crc_dat[14] ^ tx_crc_dat[17]) ^ tx_crc_dat[18]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[25]) ^ tx_crc_dat[26]) ^ tx_crc_dat[29]) ^ tx_crc_dat[31]) ^ tx_crc_cur[2]) ^ tx_crc_cur[5]) ^ tx_crc_cur[6]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[13]) ^ tx_crc_cur[14]) ^ tx_crc_cur[17]) ^ tx_crc_cur[19]);
	tx_crc_next[6] <= (((((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[13]) ^ tx_crc_dat[16]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[25]) ^ tx_crc_dat[26]) ^ tx_crc_dat[30]) ^ tx_crc_cur[0]) ^ tx_crc_cur[1]) ^ tx_crc_cur[4]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[13]) ^ tx_crc_cur[14]) ^ tx_crc_cur[18]);
	tx_crc_next[7] <= (((((((((((((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[14]) ^ tx_crc_dat[15]) ^ tx_crc_dat[16]) ^ tx_crc_dat[17]) ^ tx_crc_dat[18]) ^ tx_crc_dat[19]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[25]) ^ tx_crc_dat[26]) ^ tx_crc_dat[31]) ^ tx_crc_cur[0]) ^ tx_crc_cur[2]) ^ tx_crc_cur[3]) ^ tx_crc_cur[4]) ^ tx_crc_cur[5]) ^ tx_crc_cur[6]) ^ tx_crc_cur[7]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[13]) ^ tx_crc_cur[14]) ^ tx_crc_cur[19]);
	tx_crc_next[8] <= (((((((((((((((((((((((((tx_crc_dat[13] ^ tx_crc_dat[15]) ^ tx_crc_dat[16]) ^ tx_crc_dat[17]) ^ tx_crc_dat[18]) ^ tx_crc_dat[19]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[24]) ^ tx_crc_dat[26]) ^ tx_crc_dat[27]) ^ tx_crc_cur[1]) ^ tx_crc_cur[3]) ^ tx_crc_cur[4]) ^ tx_crc_cur[5]) ^ tx_crc_cur[6]) ^ tx_crc_cur[7]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[12]) ^ tx_crc_cur[14]) ^ tx_crc_cur[15]);
	tx_crc_next[9] <= (((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[13]) ^ tx_crc_dat[14]) ^ tx_crc_dat[15]) ^ tx_crc_dat[17]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[28]) ^ tx_crc_cur[0]) ^ tx_crc_cur[1]) ^ tx_crc_cur[2]) ^ tx_crc_cur[3]) ^ tx_crc_cur[5]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[16]);
	tx_crc_next[10] <= (((((((((((((((((tx_crc_dat[13] ^ tx_crc_dat[14]) ^ tx_crc_dat[15]) ^ tx_crc_dat[16]) ^ tx_crc_dat[18]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[24]) ^ tx_crc_dat[29]) ^ tx_crc_cur[1]) ^ tx_crc_cur[2]) ^ tx_crc_cur[3]) ^ tx_crc_cur[4]) ^ tx_crc_cur[6]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[12]) ^ tx_crc_cur[17]);
	tx_crc_next[11] <= (((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[13]) ^ tx_crc_dat[14]) ^ tx_crc_dat[17]) ^ tx_crc_dat[18]) ^ tx_crc_dat[20]) ^ tx_crc_dat[23]) ^ tx_crc_dat[27]) ^ tx_crc_dat[30]) ^ tx_crc_cur[0]) ^ tx_crc_cur[1]) ^ tx_crc_cur[2]) ^ tx_crc_cur[5]) ^ tx_crc_cur[6]) ^ tx_crc_cur[8]) ^ tx_crc_cur[11]) ^ tx_crc_cur[15]) ^ tx_crc_cur[18]);
	tx_crc_next[12] <= (((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[14]) ^ tx_crc_dat[16]) ^ tx_crc_dat[20]) ^ tx_crc_dat[21]) ^ tx_crc_dat[25]) ^ tx_crc_dat[27]) ^ tx_crc_dat[28]) ^ tx_crc_dat[31]) ^ tx_crc_cur[0]) ^ tx_crc_cur[2]) ^ tx_crc_cur[4]) ^ tx_crc_cur[8]) ^ tx_crc_cur[9]) ^ tx_crc_cur[13]) ^ tx_crc_cur[15]) ^ tx_crc_cur[16]) ^ tx_crc_cur[19]);
	tx_crc_next[13] <= (((((((((((((((tx_crc_dat[13] ^ tx_crc_dat[15]) ^ tx_crc_dat[17]) ^ tx_crc_dat[21]) ^ tx_crc_dat[22]) ^ tx_crc_dat[26]) ^ tx_crc_dat[28]) ^ tx_crc_dat[29]) ^ tx_crc_cur[1]) ^ tx_crc_cur[3]) ^ tx_crc_cur[5]) ^ tx_crc_cur[9]) ^ tx_crc_cur[10]) ^ tx_crc_cur[14]) ^ tx_crc_cur[16]) ^ tx_crc_cur[17]);
	tx_crc_next[14] <= (((((((((((((((tx_crc_dat[14] ^ tx_crc_dat[16]) ^ tx_crc_dat[18]) ^ tx_crc_dat[22]) ^ tx_crc_dat[23]) ^ tx_crc_dat[27]) ^ tx_crc_dat[29]) ^ tx_crc_dat[30]) ^ tx_crc_cur[2]) ^ tx_crc_cur[4]) ^ tx_crc_cur[6]) ^ tx_crc_cur[10]) ^ tx_crc_cur[11]) ^ tx_crc_cur[15]) ^ tx_crc_cur[17]) ^ tx_crc_cur[18]);
	tx_crc_next[15] <= (((((((((((((((tx_crc_dat[15] ^ tx_crc_dat[17]) ^ tx_crc_dat[19]) ^ tx_crc_dat[23]) ^ tx_crc_dat[24]) ^ tx_crc_dat[28]) ^ tx_crc_dat[30]) ^ tx_crc_dat[31]) ^ tx_crc_cur[3]) ^ tx_crc_cur[5]) ^ tx_crc_cur[7]) ^ tx_crc_cur[11]) ^ tx_crc_cur[12]) ^ tx_crc_cur[16]) ^ tx_crc_cur[18]) ^ tx_crc_cur[19]);
	tx_crc_next[16] <= (((((((((((((tx_crc_dat[16] ^ tx_crc_dat[18]) ^ tx_crc_dat[20]) ^ tx_crc_dat[24]) ^ tx_crc_dat[25]) ^ tx_crc_dat[29]) ^ tx_crc_dat[31]) ^ tx_crc_cur[4]) ^ tx_crc_cur[6]) ^ tx_crc_cur[8]) ^ tx_crc_cur[12]) ^ tx_crc_cur[13]) ^ tx_crc_cur[17]) ^ tx_crc_cur[19]);
	tx_crc_next[17] <= (((((((((((tx_crc_dat[17] ^ tx_crc_dat[19]) ^ tx_crc_dat[21]) ^ tx_crc_dat[25]) ^ tx_crc_dat[26]) ^ tx_crc_dat[30]) ^ tx_crc_cur[5]) ^ tx_crc_cur[7]) ^ tx_crc_cur[9]) ^ tx_crc_cur[13]) ^ tx_crc_cur[14]) ^ tx_crc_cur[18]);
	tx_crc_next[18] <= (((((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[13]) ^ tx_crc_dat[15]) ^ tx_crc_dat[16]) ^ tx_crc_dat[19]) ^ tx_crc_dat[22]) ^ tx_crc_dat[24]) ^ tx_crc_dat[25]) ^ tx_crc_dat[26]) ^ tx_crc_dat[31]) ^ tx_crc_cur[0]) ^ tx_crc_cur[1]) ^ tx_crc_cur[3]) ^ tx_crc_cur[4]) ^ tx_crc_cur[7]) ^ tx_crc_cur[10]) ^ tx_crc_cur[12]) ^ tx_crc_cur[13]) ^ tx_crc_cur[14]) ^ tx_crc_cur[19]);
	tx_crc_next[19] <= (((((((((((((((((tx_crc_dat[12] ^ tx_crc_dat[14]) ^ tx_crc_dat[15]) ^ tx_crc_dat[17]) ^ tx_crc_dat[18]) ^ tx_crc_dat[19]) ^ tx_crc_dat[23]) ^ tx_crc_dat[24]) ^ tx_crc_dat[26]) ^ tx_crc_cur[0]) ^ tx_crc_cur[2]) ^ tx_crc_cur[3]) ^ tx_crc_cur[5]) ^ tx_crc_cur[6]) ^ tx_crc_cur[7]) ^ tx_crc_cur[11]) ^ tx_crc_cur[12]) ^ tx_crc_cur[14]);
end
assign tx_reset2 = tx_reset1;
always @(*) begin
	tx_strobe_crc_clockdomainsrenamer_next_value6 <= 1'd0;
	tx_strobe_crc_clockdomainsrenamer_next_value_ce6 <= 1'd0;
	next_state <= 3'd0;
	tx_change_disp_clockdomainsrenamer_next_value0 <= 1'd0;
	tx_eop_clockdomainsrenamer_next_value7 <= 1'd0;
	tx_change_disp_clockdomainsrenamer_next_value_ce0 <= 1'd0;
	tx_eop_clockdomainsrenamer_next_value_ce7 <= 1'd0;
	tx_fifo_re1_clockdomainsrenamer_next_value1 <= 1'd0;
	tx_fifo_re1_clockdomainsrenamer_next_value_ce1 <= 1'd0;
	tx_sop_clockdomainsrenamer_next_value2 <= 1'd0;
	tx_sop_clockdomainsrenamer_next_value_ce2 <= 1'd0;
	tx_idle_clockdomainsrenamer_next_value3 <= 1'd0;
	tx_idle_clockdomainsrenamer_next_value_ce3 <= 1'd0;
	tx_encoder_ready_clockdomainsrenamer_next_value4 <= 1'd0;
	tx_encoder_ready_clockdomainsrenamer_next_value_ce4 <= 1'd0;
	tx_fifo_ready_clockdomainsrenamer_next_value5 <= 1'd0;
	tx_fifo_ready_clockdomainsrenamer_next_value_ce5 <= 1'd0;
	next_state <= state;
	case (state)
		1'd1: begin
			if (((~tx_fifo_empty1) & tx_link_ready1)) begin
				next_state <= 2'd2;
				tx_fifo_re1_clockdomainsrenamer_next_value1 <= 1'd1;
				tx_fifo_re1_clockdomainsrenamer_next_value_ce1 <= 1'd1;
				tx_sop_clockdomainsrenamer_next_value2 <= 1'd1;
				tx_sop_clockdomainsrenamer_next_value_ce2 <= 1'd1;
				tx_change_disp_clockdomainsrenamer_next_value0 <= 1'd1;
				tx_change_disp_clockdomainsrenamer_next_value_ce0 <= 1'd1;
				tx_idle_clockdomainsrenamer_next_value3 <= 1'd0;
				tx_idle_clockdomainsrenamer_next_value_ce3 <= 1'd1;
			end else begin
				tx_idle_clockdomainsrenamer_next_value3 <= 1'd1;
				tx_idle_clockdomainsrenamer_next_value_ce3 <= 1'd1;
			end
		end
		2'd2: begin
			next_state <= 2'd3;
			tx_encoder_ready_clockdomainsrenamer_next_value4 <= 1'd1;
			tx_encoder_ready_clockdomainsrenamer_next_value_ce4 <= 1'd1;
			tx_fifo_ready_clockdomainsrenamer_next_value5 <= 1'd1;
			tx_fifo_ready_clockdomainsrenamer_next_value_ce5 <= 1'd1;
			tx_fifo_re1_clockdomainsrenamer_next_value1 <= 1'd1;
			tx_fifo_re1_clockdomainsrenamer_next_value_ce1 <= 1'd1;
			tx_sop_clockdomainsrenamer_next_value2 <= 1'd0;
			tx_sop_clockdomainsrenamer_next_value_ce2 <= 1'd1;
			tx_strobe_crc_clockdomainsrenamer_next_value6 <= 1'd1;
			tx_strobe_crc_clockdomainsrenamer_next_value_ce6 <= 1'd1;
		end
		2'd3: begin
			tx_encoder_ready_clockdomainsrenamer_next_value4 <= 1'd1;
			tx_encoder_ready_clockdomainsrenamer_next_value_ce4 <= 1'd1;
			...
			if ((tx_data_type == 2'd2)) begin
				tx_eop_clockdomainsrenamer_next_value7 <= 1'd1;
				tx_eop_clockdomainsrenamer_next_value_ce7 <= 1'd1;
				tx_fifo_re1_clockdomainsrenamer_next_value1 <= 1'd0;
				tx_fifo_re1_clockdomainsrenamer_next_value_ce1 <= 1'd1;
				next_state <= 3'd4;
				tx_strobe_crc_clockdomainsrenamer_next_value6 <= 1'd0;
...
always @(posedge tx_clk) begin
	...
	state <= next_state;
	if (tx_change_disp_clockdomainsrenamer_next_value_ce0) begin
		tx_change_disp <= tx_change_disp_clockdomainsrenamer_next_value0;
	end
	if (tx_fifo_re1_clockdomainsrenamer_next_value_ce1) begin
		tx_fifo_re1 <= tx_fifo_re1_clockdomainsrenamer_next_value1;
	end
	if (tx_sop_clockdomainsrenamer_next_value_ce2) begin
		tx_sop <= tx_sop_clockdomainsrenamer_next_value2;
	end
	if (tx_idle_clockdomainsrenamer_next_value_ce3) begin
		tx_idle <= tx_idle_clockdomainsrenamer_next_value3;
	end
	if (tx_encoder_ready_clockdomainsrenamer_next_value_ce4) begin
		tx_encoder_ready <= tx_encoder_ready_clockdomainsrenamer_next_value4;
	end
	if (tx_fifo_ready_clockdomainsrenamer_next_value_ce5) begin
		tx_fifo_ready <= tx_fifo_ready_clockdomainsrenamer_next_value5;
	end
	if (tx_strobe_crc_clockdomainsrenamer_next_value_ce6) begin
		tx_strobe_crc <= tx_strobe_crc_clockdomainsrenamer_next_value6;
	end
	if (tx_eop_clockdomainsrenamer_next_value_ce7) begin
		tx_eop <= tx_eop_clockdomainsrenamer_next_value7;
	end
	if (tx_reset2) begin
		tx_sop <= 1'd0;
		tx_eop <= 1'd0;
