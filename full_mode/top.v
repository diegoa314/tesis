//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-05-12 18:20:01
//--------------------------------------------------------------------------------
module top(
	input clk0_clk_p,
	input clk0_clk_n,
...
reg [5:0] gtp_tx_init_pll_reset_timer_count = 6'd32;
wire gtp_tx_init_reset;
wire gtp_tx_init_ready_timer_wait;
wire gtp_tx_init_ready_timer_done;
reg [15:0] gtp_tx_init_ready_timer_count = 16'd62500;
...
always @(posedge sys_clk) begin
	...
	if (gtp_tx_init_pll_reset_timer_wait) begin
		...
		gtp_tx_init_pll_reset_timer_count <= 6'd32;
	end
	...
	if (gtp_tx_init_ready_timer_wait) begin
		...
		gtp_tx_init_ready_timer_count <= 16'd62500;
	end
	if (sys_rst) begin
