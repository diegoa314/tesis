//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-07-06 15:33:42
//--------------------------------------------------------------------------------
module top(
	input reset,
	input write_clk_p,
...
wire rx_tx_serial0;
wire rx_aligned0;
reg [31:0] rx_din = 32'd0;
wire rx_aligned1;
reg [31:0] rx_dout = 32'd0;
reg rx_correction_done = 1'd0;
reg [15:0] rx_first_half = 16'd0;
...
reg [1:0] tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value3 = 2'd0;
reg tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value_ce3 = 1'd0;
reg tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value4 = 1'd0;
reg tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value_ce4 = 1'd0;
reg tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value0 = 1'd0;
reg tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value_ce0 = 1'd0;
reg tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value1 = 1'd0;
reg tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value_ce1 = 1'd0;
...
reg [15:0] rx_first_half_alignment_corrector_next_value0 = 16'd0;
reg rx_first_half_alignment_corrector_next_value_ce0 = 1'd0;
reg rx_correction_done_alignment_corrector_next_value1 = 1'd0;
reg rx_correction_done_alignment_corrector_next_value_ce1 = 1'd0;
reg [31:0] rx_dout_alignment_corrector_next_value2 = 32'd0;
reg rx_dout_alignment_corrector_next_value_ce2 = 1'd0;
reg [1:0] fsm_state0 = 2'd0;
reg [1:0] fsm_next_state0 = 2'd0;
reg rx_tx_ready_transmitter32b_next_value0 = 1'd0;
reg rx_tx_ready_transmitter32b_next_value_ce0 = 1'd0;
reg [7:0] rx_tx_data_transmitter32b_next_value1 = 8'd0;
reg rx_tx_data_transmitter32b_next_value_ce1 = 1'd0;
reg rx_tx_32bdone_transmitter32b_next_value2 = 1'd0;
reg rx_tx_32bdone_transmitter32b_next_value_ce2 = 1'd0;
reg [3:0] rx_byte_cnt_transmitter32b_next_value3 = 4'd0;
reg rx_byte_cnt_transmitter32b_next_value_ce3 = 1'd0;
reg [1:0] tx_state = 2'd0;
reg [1:0] tx_next_state = 2'd0;
reg [7:0] rx_tx_latch_transmitter32b_t_next_value0 = 8'd0;
reg rx_tx_latch_transmitter32b_t_next_value_ce0 = 1'd0;
reg [4:0] rx_tx_counter_transmitter32b_t_next_value1 = 5'd0;
reg rx_tx_counter_transmitter32b_t_next_value_ce1 = 1'd0;
reg rx_tx_serial2_transmitter32b_f_next_value = 1'd0;
reg rx_tx_serial2_transmitter32b_f_next_value_ce = 1'd0;
reg [2:0] rx_tx_bitn_transmitter32b_t_next_value2 = 3'd0;
reg rx_tx_bitn_transmitter32b_t_next_value_ce2 = 1'd0;
reg rx_tx_done_transmitter32b_t_next_value3 = 1'd0;
reg rx_tx_done_transmitter32b_t_next_value_ce3 = 1'd0;
reg [1:0] fsm_state1 = 2'd0;
reg [1:0] fsm_next_state1 = 2'd0;
...
assign rx_aligned0 = gtp_rxbytealigned;
...
assign tx_stream_controller_fifo_empty = tx_fifo_empty;
assign tx_stream_controller_data_type = tx_data_type_in;
assign tx_stream_controller_system_ready = (tx_tx_init_done & tx_pll_lock);
...
always @(*) begin
	...
	tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value0 <= 1'd0;
	tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value_ce0 <= 1'd0;
	...
	tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value1 <= 1'd0;
	tx_stream_controller_idle_clockdomainsrenamer0_t_next_value_ce2 <= 1'd0;
	tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value_ce1 <= 1'd0;
	tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value3 <= 2'd0;
	tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value_ce3 <= 1'd0;
	tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value4 <= 1'd0;
	tx_stream_controller_aux_ign_clockdomainsrenamer0_cases_next_value0 <= 1'd0;
	tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value_ce4 <= 1'd0;
	...
	case (clockdomainsrenamer0_state)
		1'd1: begin
			if (tx_stream_controller_link_ready) begin
				if (tx_stream_controller_fifo_empty) begin
					tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value3 <= (tx_stream_controller_counter_idle + 1'd1);
					tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value_ce3 <= 1'd1;
					if ((tx_stream_controller_counter_idle == 2'd2)) begin
						clockdomainsrenamer0_next_state <= 2'd2;
						tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value4 <= 1'd1;
						tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value_ce4 <= 1'd1;
					end else begin
						clockdomainsrenamer0_next_state <= 1'd1;
					end
				end else begin
					if ((tx_stream_controller_data_type == 1'd1)) begin
		...
		2'd3: begin
			...
			tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value4 <= 1'd1;
			tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value_ce4 <= 1'd1;
			tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value0 <= 1'd1;
			tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
			tx_stream_controller_fifo_re_clockdomainsrenamer0_t_next_value0 <= 1'd1;
			tx_stream_controller_fifo_re_clockdomainsrenamer0_t_next_value_ce0 <= 1'd1;
			tx_stream_controller_sop_clockdomainsrenamer0_t_next_value1 <= 1'd0;
			tx_stream_controller_sop_clockdomainsrenamer0_t_next_value_ce1 <= 1'd1;
			tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value1 <= 1'd1;
			tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value_ce1 <= 1'd1;
		end
		3'd4: begin
			if (tx_stream_controller_fifo_empty) begin
				clockdomainsrenamer0_next_state <= 1'd0;
		...
		3'd5: begin
			clockdomainsrenamer0_next_state <= 3'd6;
			tx_stream_controller_eop_clockdomainsrenamer0_cases_next_value1 <= 1'd0;
			tx_stream_controller_eop_clockdomainsrenamer0_cases_next_value_ce1 <= 1'd1;
			tx_stream_controller_reset_crc_clockdomainsrenamer0_cases_next_value2 <= 1'd0;
			tx_stream_controller_reset_crc_clockdomainsrenamer0_cases_next_value_ce2 <= 1'd1;
		...
		3'd6: begin
			tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value0 <= 1'd0;
			tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
			clockdomainsrenamer0_next_state <= 3'd7;
		end
		3'd7: begin
			clockdomainsrenamer0_next_state <= 2'd2;
		end
		default: begin
			if ((tx_stream_controller_link_ready & tx_stream_controller_system_ready)) begin
...
always @(*) begin
	rx_din <= 32'd0;
	rx_din[7:0] <= rx_decoder1_d;
	rx_din[15:8] <= rx_decoder2_d;
	rx_din[23:16] <= rx_decoder3_d;
	rx_din[31:24] <= rx_decoder4_d;
end
assign rx_data_32b = rx_dout;
...
always @(*) begin
	rx_first_half_alignment_corrector_next_value0 <= 16'd0;
	rx_first_half_alignment_corrector_next_value_ce0 <= 1'd0;
	rx_correction_done_alignment_corrector_next_value1 <= 1'd0;
	rx_correction_done_alignment_corrector_next_value_ce1 <= 1'd0;
	rx_dout_alignment_corrector_next_value2 <= 32'd0;
	alignment_corrector_next_state <= 2'd0;
	rx_dout_alignment_corrector_next_value_ce2 <= 1'd0;
	...
	case (alignment_corrector_state)
		1'd1: begin
			...
			rx_first_half_alignment_corrector_next_value0 <= rx_din[31:16];
			rx_first_half_alignment_corrector_next_value_ce0 <= 1'd1;
			rx_correction_done_alignment_corrector_next_value1 <= 1'd1;
			rx_correction_done_alignment_corrector_next_value_ce1 <= 1'd1;
		end
		2'd2: begin
			rx_dout_alignment_corrector_next_value2 <= {rx_din[15:0], rx_first_half};
			rx_dout_alignment_corrector_next_value_ce2 <= 1'd1;
			rx_first_half_alignment_corrector_next_value0 <= rx_din[31:16];
			rx_first_half_alignment_corrector_next_value_ce0 <= 1'd1;
			alignment_corrector_next_state <= 2'd2;
		end
...
always @(*) begin
	rx_tx_32bdone_transmitter32b_next_value2 <= 1'd0;
	rx_tx_32bdone_transmitter32b_next_value_ce2 <= 1'd0;
	rx_byte_cnt_transmitter32b_next_value3 <= 4'd0;
	rx_byte_cnt_transmitter32b_next_value_ce3 <= 1'd0;
	fsm_next_state0 <= 2'd0;
	rx_tx_ready_transmitter32b_next_value0 <= 1'd0;
	rx_tx_ready_transmitter32b_next_value_ce0 <= 1'd0;
	rx_tx_data_transmitter32b_next_value1 <= 8'd0;
	rx_tx_data_transmitter32b_next_value_ce1 <= 1'd0;
	fsm_next_state0 <= fsm_state0;
	case (fsm_state0)
		1'd1: begin
			if (rx_tx_done) begin
				rx_byte_cnt_transmitter32b_next_value3 <= (rx_byte_cnt + 1'd1);
				rx_byte_cnt_transmitter32b_next_value_ce3 <= 1'd1;
				if ((rx_byte_cnt < 2'd3)) begin
					rx_tx_ready_transmitter32b_next_value0 <= 1'd1;
					rx_tx_ready_transmitter32b_next_value_ce0 <= 1'd1;
					fsm_next_state0 <= 2'd2;
				end else begin
					fsm_next_state0 <= 1'd0;
					rx_tx_32bdone_transmitter32b_next_value2 <= 1'd1;
					rx_tx_32bdone_transmitter32b_next_value_ce2 <= 1'd1;
					rx_tx_ready_transmitter32b_next_value0 <= 1'd0;
					rx_tx_ready_transmitter32b_next_value_ce0 <= 1'd1;
					rx_byte_cnt_transmitter32b_next_value3 <= 1'd0;
					rx_byte_cnt_transmitter32b_next_value_ce3 <= 1'd1;
				end
			end
		end
		2'd2: begin
			case (rx_byte_cnt)
				1'd1: begin
					rx_tx_data_transmitter32b_next_value1 <= rx_data_in1[15:8];
					rx_tx_data_transmitter32b_next_value_ce1 <= 1'd1;
				end
				2'd2: begin
					rx_tx_data_transmitter32b_next_value1 <= rx_data_in1[23:16];
					rx_tx_data_transmitter32b_next_value_ce1 <= 1'd1;
				end
				2'd3: begin
					rx_tx_data_transmitter32b_next_value1 <= rx_data_in1[31:24];
					rx_tx_data_transmitter32b_next_value_ce1 <= 1'd1;
				end
			endcase
			if ((~rx_tx_done)) begin
		...
		default: begin
			if (((rx_trans_en1 & (~rx_tx_done)) & (~rx_fifoEmpty))) begin
				...
				rx_tx_ready_transmitter32b_next_value0 <= 1'd1;
				rx_tx_ready_transmitter32b_next_value_ce0 <= 1'd1;
				rx_tx_data_transmitter32b_next_value1 <= rx_data_in1[7:0];
				rx_tx_data_transmitter32b_next_value_ce1 <= 1'd1;
			end else begin
				fsm_next_state0 <= 1'd0;
				rx_tx_ready_transmitter32b_next_value0 <= 1'd0;
...
always @(*) begin
	tx_next_state <= 2'd0;
	rx_tx_latch_transmitter32b_t_next_value0 <= 8'd0;
	rx_tx_done_transmitter32b_t_next_value3 <= 1'd0;
	rx_tx_latch_transmitter32b_t_next_value_ce0 <= 1'd0;
	rx_tx_done_transmitter32b_t_next_value_ce3 <= 1'd0;
	rx_tx_counter_transmitter32b_t_next_value1 <= 5'd0;
	rx_tx_counter_transmitter32b_t_next_value_ce1 <= 1'd0;
	rx_tx_serial2_transmitter32b_f_next_value <= 1'd0;
	rx_tx_serial2_transmitter32b_f_next_value_ce <= 1'd0;
	rx_tx_bitn_transmitter32b_t_next_value2 <= 3'd0;
	rx_tx_bitn_transmitter32b_t_next_value_ce2 <= 1'd0;
	tx_next_state <= tx_state;
	case (tx_state)
		1'd1: begin
			if (rx_tx_strobe) begin
				rx_tx_serial2_transmitter32b_f_next_value <= 1'd0;
				rx_tx_serial2_transmitter32b_f_next_value_ce <= 1'd1;
				tx_next_state <= 2'd2;
			end
		end
		2'd2: begin
			if (rx_tx_strobe) begin
				rx_tx_serial2_transmitter32b_f_next_value <= rx_tx_latch[0];
				rx_tx_serial2_transmitter32b_f_next_value_ce <= 1'd1;
				rx_tx_latch_transmitter32b_t_next_value0 <= {1'd0, rx_tx_latch[7:1]};
				rx_tx_latch_transmitter32b_t_next_value_ce0 <= 1'd1;
				rx_tx_bitn_transmitter32b_t_next_value2 <= (rx_tx_bitn + 1'd1);
				rx_tx_bitn_transmitter32b_t_next_value_ce2 <= 1'd1;
				if ((rx_tx_bitn == 3'd7)) begin
					tx_next_state <= 2'd3;
					rx_tx_bitn_transmitter32b_t_next_value2 <= 1'd0;
					rx_tx_bitn_transmitter32b_t_next_value_ce2 <= 1'd1;
					rx_tx_done_transmitter32b_t_next_value3 <= 1'd1;
					rx_tx_done_transmitter32b_t_next_value_ce3 <= 1'd1;
				end
			end
		end
		2'd3: begin
			if (rx_tx_strobe) begin
				rx_tx_serial2_transmitter32b_f_next_value <= 1'd1;
				rx_tx_serial2_transmitter32b_f_next_value_ce <= 1'd1;
				rx_tx_done_transmitter32b_t_next_value3 <= 1'd0;
				rx_tx_done_transmitter32b_t_next_value_ce3 <= 1'd1;
				tx_next_state <= 1'd0;
		...
		default: begin
			if (rx_tx_ready) begin
				rx_tx_latch_transmitter32b_t_next_value0 <= rx_tx_data;
				rx_tx_latch_transmitter32b_t_next_value_ce0 <= 1'd1;
				rx_tx_counter_transmitter32b_t_next_value1 <= 5'd29;
				rx_tx_counter_transmitter32b_t_next_value_ce1 <= 1'd1;
				tx_next_state <= 1'd1;
			end else begin
				rx_tx_serial2_transmitter32b_f_next_value <= 1'd1;
				rx_tx_serial2_transmitter32b_f_next_value_ce <= 1'd1;
...
always @(posedge tx_clk) begin
	...
	if (tx_stream_controller_fifo_ready) begin
	...
	if (tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value_ce3) begin
		tx_stream_controller_counter_idle <= tx_stream_controller_counter_idle_clockdomainsrenamer0_t_next_value3;
	end
	if (tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value_ce4) begin
		tx_stream_controller_encoder_ready <= tx_stream_controller_encoder_ready_clockdomainsrenamer0_t_next_value4;
	end
	if (tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value_ce0) begin
		tx_stream_controller_fifo_ready <= tx_stream_controller_fifo_ready_clockdomainsrenamer0_next_value0;
	end
	if (tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value_ce1) begin
		tx_stream_controller_strobe_crc <= tx_stream_controller_strobe_crc_clockdomainsrenamer0_next_value1;
	end
	...
	if (tx_stream_controller_reset) begin
		...
		tx_stream_controller_fifo_ready <= 1'd0;
		...
		tx_stream_controller_counter_idle <= 2'd0;
		clockdomainsrenamer0_state <= 3'd0;
	end
	alignment_corrector_state <= alignment_corrector_next_state;
	if (rx_first_half_alignment_corrector_next_value_ce0) begin
		rx_first_half <= rx_first_half_alignment_corrector_next_value0;
	end
	if (rx_correction_done_alignment_corrector_next_value_ce1) begin
		rx_correction_done <= rx_correction_done_alignment_corrector_next_value1;
	end
	if (rx_dout_alignment_corrector_next_value_ce2) begin
		rx_dout <= rx_dout_alignment_corrector_next_value2;
	end
	fsm_state0 <= fsm_next_state0;
	if (rx_tx_ready_transmitter32b_next_value_ce0) begin
		rx_tx_ready <= rx_tx_ready_transmitter32b_next_value0;
	end
	if (rx_tx_data_transmitter32b_next_value_ce1) begin
		rx_tx_data <= rx_tx_data_transmitter32b_next_value1;
	end
	if (rx_tx_32bdone_transmitter32b_next_value_ce2) begin
		rx_tx_32bdone <= rx_tx_32bdone_transmitter32b_next_value2;
	end
	if (rx_byte_cnt_transmitter32b_next_value_ce3) begin
		rx_byte_cnt <= rx_byte_cnt_transmitter32b_next_value3;
	end
	...
	if (rx_tx_latch_transmitter32b_t_next_value_ce0) begin
		rx_tx_latch <= rx_tx_latch_transmitter32b_t_next_value0;
	end
	if (rx_tx_counter_transmitter32b_t_next_value_ce1) begin
		rx_tx_counter <= rx_tx_counter_transmitter32b_t_next_value1;
	end
	if (rx_tx_serial2_transmitter32b_f_next_value_ce) begin
		rx_tx_serial2 <= rx_tx_serial2_transmitter32b_f_next_value;
	end
	if (rx_tx_bitn_transmitter32b_t_next_value_ce2) begin
		rx_tx_bitn <= rx_tx_bitn_transmitter32b_t_next_value2;
	end
	if (rx_tx_done_transmitter32b_t_next_value_ce3) begin
		rx_tx_done <= rx_tx_done_transmitter32b_t_next_value3;
	end
