//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-06-26 15:34:48
//--------------------------------------------------------------------------------
module top(
	input write_clk_p,
	input write_clk_n,
...
wire tx_fsm_reset1;
wire [39:0] rx_data_in;
reg [31:0] rx_data_out = 32'd0;
...
assign rx_data_in = dout;
assign data_received = rx_data_out;
...
assign rx_decoder1_input = rx_data_in[9:0];
assign rx_decoder2_input = rx_data_in[19:10];
assign rx_decoder3_input = rx_data_in[29:20];
assign rx_decoder4_input = rx_data_in[39:30];
always @(*) begin
	rx_data_out <= 32'd0;
	rx_data_out[7:0] <= rx_decoder1_d;
	rx_data_out[15:8] <= rx_decoder2_d;
	rx_data_out[23:16] <= rx_decoder3_d;
	rx_data_out[31:24] <= rx_decoder4_d;
end
...
always @(posedge write_clk) begin
	...
	memadr_6 <= wrport1_adr;
end

always @(posedge tx_clk) begin
	memadr_7 <= rdport1_adr;
end

assign wrport1_dat_r = storaget[memadr_6];
assign rdport1_dat_r = storaget[memadr_7];
