//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-07-03 16:36:22
//--------------------------------------------------------------------------------
module top(
	input reset,
	input write_clk_p,
...
wire [4:0] memory_index;
wire [31:0] memory_data_out;
wire [1:0] memory_type_out;
wire [3:0] memory_wrport1_adr;
wire [31:0] memory_wrport1_dat_r;
wire [3:0] memory_wrport2_adr;
wire [1:0] memory_wrport2_dat_r;
reg [4:0] index = 5'd0;
reg write_fifo = 1'd0;
...
reg [4:0] index_clockdomainsrenamer3_next_value0 = 5'd0;
reg index_clockdomainsrenamer3_next_value_ce0 = 1'd0;
reg write_fifo_clockdomainsrenamer3_next_value1 = 1'd0;
reg write_fifo_clockdomainsrenamer3_next_value_ce1 = 1'd0;
...
assign memory_index = index;
assign fifo_asyncfifo_din = memory_data_out;
assign fifo_asyncfifo_dtin = memory_type_out;
...
assign memory_wrport1_adr = memory_index;
assign memory_wrport2_adr = memory_index;
assign memory_data_out = memory_wrport1_dat_r;
assign memory_type_out = memory_wrport2_dat_r;
always @(*) begin
	write_fifo_clockdomainsrenamer3_next_value1 <= 1'd0;
	write_fifo_clockdomainsrenamer3_next_value_ce1 <= 1'd0;
	fsm_next_state <= 2'd0;
	index_clockdomainsrenamer3_next_value0 <= 5'd0;
	index_clockdomainsrenamer3_next_value_ce0 <= 1'd0;
	fsm_next_state <= fsm_state;
	case (fsm_state)
		1'd1: begin
			index_clockdomainsrenamer3_next_value0 <= (index + 1'd1);
			index_clockdomainsrenamer3_next_value_ce0 <= 1'd1;
			if ((index == 4'd14)) begin
				index_clockdomainsrenamer3_next_value0 <= 1'd0;
				index_clockdomainsrenamer3_next_value_ce0 <= 1'd1;
				fsm_next_state <= 2'd2;
				write_fifo_clockdomainsrenamer3_next_value1 <= 1'd0;
				write_fifo_clockdomainsrenamer3_next_value_ce1 <= 1'd1;
			end
		end
		2'd2: begin
			fsm_next_state <= 2'd3;
		...
		default: begin
			if (we) begin
				index_clockdomainsrenamer3_next_value0 <= 1'd1;
				index_clockdomainsrenamer3_next_value_ce0 <= 1'd1;
				fsm_next_state <= 1'd1;
				write_fifo_clockdomainsrenamer3_next_value1 <= 1'd1;
				write_fifo_clockdomainsrenamer3_next_value_ce1 <= 1'd1;
			end
		end
	endcase
...
always @(posedge write_clk) begin
	...
	if (index_clockdomainsrenamer3_next_value_ce0) begin
		index <= index_clockdomainsrenamer3_next_value0;
	end
	if (write_fifo_clockdomainsrenamer3_next_value_ce1) begin
		write_fifo <= write_fifo_clockdomainsrenamer3_next_value1;
	end
	if (write_rst) begin
...
reg [31:0] memdat_2;
always @(posedge write_clk) begin
	memdat_2 <= INPUT[memory_wrport1_adr];
end

assign memory_wrport1_dat_r = memdat_2;
...
reg [1:0] memdat_3;
always @(posedge write_clk) begin
	memdat_3 <= TYPE[memory_wrport2_adr];
end

assign memory_wrport2_dat_r = memdat_3;
