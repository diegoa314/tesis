//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-07-13 15:52:33
//--------------------------------------------------------------------------------
module top(
	input reset,
	input write_clk_p,
...
reg rx_corrector_correction_done = 1'd0;
reg [15:0] rx_corrector_first_half = 16'd0;
...
reg [15:0] rx_corrector_first_half_alignment_corrector_next_value0 = 16'd0;
reg rx_corrector_first_half_alignment_corrector_next_value_ce0 = 1'd0;
reg rx_corrector_correction_done_alignment_corrector_next_value1 = 1'd0;
reg rx_corrector_correction_done_alignment_corrector_next_value_ce1 = 1'd0;
...
assign asyncfifo_din = o;
assign asyncfifo_dtin = data_type;
...
always @(*) begin
	gtp_gtprxinit_restart <= 1'd0;
	if ((~gtp_tx_init_done1)) begin
		gtp_gtprxinit_restart <= 1'd1;
	end
end
...
assign tx_stream_controller_tx_init_done = tx_tx_init_done;
...
always @(*) begin
	rx_corrector_first_half_alignment_corrector_next_value0 <= 16'd0;
	rx_corrector_first_half_alignment_corrector_next_value_ce0 <= 1'd0;
	rx_corrector_correction_done_alignment_corrector_next_value1 <= 1'd0;
	rx_corrector_correction_done_alignment_corrector_next_value_ce1 <= 1'd0;
	rx_corrector_dout <= 32'd0;
	rx_next_state <= 2'd0;
	rx_next_state <= rx_state;
	case (rx_state)
		1'd1: begin
			rx_next_state <= 2'd2;
			rx_corrector_first_half_alignment_corrector_next_value0 <= rx_corrector_din[31:16];
			rx_corrector_first_half_alignment_corrector_next_value_ce0 <= 1'd1;
			rx_corrector_correction_done_alignment_corrector_next_value1 <= 1'd1;
			rx_corrector_correction_done_alignment_corrector_next_value_ce1 <= 1'd1;
		end
		2'd2: begin
			rx_corrector_dout <= {rx_corrector_din[15:0], rx_corrector_first_half};
			rx_corrector_first_half_alignment_corrector_next_value0 <= rx_corrector_din[31:16];
			rx_corrector_first_half_alignment_corrector_next_value_ce0 <= 1'd1;
			rx_next_state <= 2'd2;
		end
		default: begin
			if (rx_corrector_aligned) begin
				rx_next_state <= 1'd1;
			end
		end
	endcase
...
always @(posedge rx_clk) begin
	rx_rx_k0 <= rx_decoder3_k;
	rx_state <= rx_next_state;
	if (rx_corrector_first_half_alignment_corrector_next_value_ce0) begin
		rx_corrector_first_half <= rx_corrector_first_half_alignment_corrector_next_value0;
	end
	if (rx_corrector_correction_done_alignment_corrector_next_value_ce1) begin
		rx_corrector_correction_done <= rx_corrector_correction_done_alignment_corrector_next_value1;
	end
	...
	if (rx_rst) begin
		rx_corrector_correction_done <= 1'd0;
		rx_corrector_first_half <= 16'd0;
		rx_rx_k0 <= 1'd0;
		rx_decoder1_k <= 1'd0;
...
always @(posedge write_clk) begin
	...
	if (enable) begin
		state <= {(state[26] ^ state[29]), (state[25] ^ state[28]), (state[24] ^ state[27]), (state[23] ^ state[26]), (state[22] ^ state[25]), (state[21] ^ state[24]), (state[20] ^ state[23]), (state[19] ^ state[22]), (state[18] ^ state[21]), (state[17] ^ state[20]), (state[16] ^ state[19]), (state[15] ^ state[18]), (state[14] ^ state[17]), (state[13] ^ state[16]), (state[12] ^ state[15]), (state[11] ^ state[14]), (state[10] ^ state[13]), (state[9] ^ state[12]), (state[8] ^ state[11]), (state[7] ^ state[10]), (state[6] ^ state[9]), (state[5] ^ state[8]), (state[4] ^ state[7]), (state[3] ^ state[6]), (state[2] ^ state[5]), (state[1] ^ state[4]), (state[0] ^ state[3]), ((state[27] ^ state[30]) ^ state[2]), ((state[26] ^ state[29]) ^ state[1]), ((state[25] ^ state[28]) ^ state[0]), ((state[24] ^ state[27]) ^ (state[27] ^ state[30]))};
		o <= {(state[27] ^ state[30]), (state[26] ^ state[29]), (state[25] ^ state[28]), (state[24] ^ state[27]), (state[23] ^ state[26]), (state[22] ^ state[25]), (state[21] ^ state[24]), (state[20] ^ state[23]), (state[19] ^ state[22]), (state[18] ^ state[21]), (state[17] ^ state[20]), (state[16] ^ state[19]), (state[15] ^ state[18]), (state[14] ^ state[17]), (state[13] ^ state[16]), (state[12] ^ state[15]), (state[11] ^ state[14]), (state[10] ^ state[13]), (state[9] ^ state[12]), (state[8] ^ state[11]), (state[7] ^ state[10]), (state[6] ^ state[9]), (state[5] ^ state[8]), (state[4] ^ state[7]), (state[3] ^ state[6]), (state[2] ^ state[5]), (state[1] ^ state[4]), (state[0] ^ state[3]), ((state[27] ^ state[30]) ^ state[2]), ((state[26] ^ state[29]) ^ state[1]), ((state[25] ^ state[28]) ^ state[0]), ((state[24] ^ state[27]) ^ (state[27] ^ state[30]))};
	end
