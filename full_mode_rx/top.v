//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-06-30 16:51:12
//--------------------------------------------------------------------------------
module top(
	input reset,
	input write_clk_p,
...
reg [1:0] tx_fsm_counter_idle_clockdomainsrenamer0_next_value3 = 2'd0;
reg tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce3 = 1'd0;
reg tx_fsm_encoder_ready_clockdomainsrenamer0_next_value4 = 1'd0;
reg tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce4 = 1'd0;
reg tx_fsm_fifo_ready_clockdomainsrenamer0_next_value5 = 1'd0;
reg tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce5 = 1'd0;
reg tx_fsm_strobe_crc_clockdomainsrenamer0_next_value6 = 1'd0;
reg tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce6 = 1'd0;
reg tx_fsm_eop_clockdomainsrenamer0_next_value7 = 1'd0;
reg tx_fsm_eop_clockdomainsrenamer0_next_value_ce7 = 1'd0;
reg tx_fsm_reset_crc_clockdomainsrenamer0_next_value8 = 1'd0;
reg tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce8 = 1'd0;
...
always @(*) begin
	tx_fsm_counter_idle_clockdomainsrenamer0_next_value3 <= 2'd0;
	tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce3 <= 1'd0;
	tx_fsm_eop_clockdomainsrenamer0_next_value7 <= 1'd0;
	tx_fsm_encoder_ready_clockdomainsrenamer0_next_value4 <= 1'd0;
	tx_fsm_eop_clockdomainsrenamer0_next_value_ce7 <= 1'd0;
	tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce4 <= 1'd0;
	tx_fsm_reset_crc_clockdomainsrenamer0_next_value8 <= 1'd0;
	tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce8 <= 1'd0;
	tx_next_state <= 3'd0;
	tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd0;
	tx_fsm_fifo_ready_clockdomainsrenamer0_next_value5 <= 1'd0;
	tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd0;
	tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce5 <= 1'd0;
	tx_fsm_sop_clockdomainsrenamer0_next_value1 <= 1'd0;
	tx_fsm_sop_clockdomainsrenamer0_next_value_ce1 <= 1'd0;
	tx_fsm_strobe_crc_clockdomainsrenamer0_next_value6 <= 1'd0;
	tx_fsm_idle_clockdomainsrenamer0_next_value2 <= 1'd0;
	tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce6 <= 1'd0;
	...
	case (tx_state)
		1'd1: begin
			if (tx_fsm_link_ready) begin
				if (tx_fsm_fifo_empty) begin
					tx_fsm_counter_idle_clockdomainsrenamer0_next_value3 <= (tx_fsm_counter_idle + 1'd1);
					tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce3 <= 1'd1;
					if ((tx_fsm_counter_idle == 2'd2)) begin
						tx_next_state <= 2'd2;
						tx_fsm_encoder_ready_clockdomainsrenamer0_next_value4 <= 1'd1;
						tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce4 <= 1'd1;
					end else begin
						tx_next_state <= 1'd1;
					end
				end else begin
		...
		2'd3: begin
			...
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value4 <= 1'd1;
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce4 <= 1'd1;
			tx_fsm_fifo_ready_clockdomainsrenamer0_next_value5 <= 1'd1;
			tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce5 <= 1'd1;
			tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd1;
			tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
			tx_fsm_sop_clockdomainsrenamer0_next_value1 <= 1'd0;
			tx_fsm_sop_clockdomainsrenamer0_next_value_ce1 <= 1'd1;
			tx_fsm_strobe_crc_clockdomainsrenamer0_next_value6 <= 1'd1;
			tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce6 <= 1'd1;
		end
		3'd4: begin
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value4 <= 1'd1;
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce4 <= 1'd1;
			...
			if ((tx_fsm_data_type == 2'd2)) begin
				tx_fsm_eop_clockdomainsrenamer0_next_value7 <= 1'd1;
				tx_fsm_eop_clockdomainsrenamer0_next_value_ce7 <= 1'd1;
				tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd0;
				tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
				tx_next_state <= 3'd5;
				tx_fsm_strobe_crc_clockdomainsrenamer0_next_value6 <= 1'd0;
				tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce6 <= 1'd1;
				tx_fsm_reset_crc_clockdomainsrenamer0_next_value8 <= 1'd1;
				tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce8 <= 1'd1;
			end
		end
		3'd5: begin
			tx_next_state <= 3'd6;
...
always @(posedge tx_clk) begin
	...
	if (tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce3) begin
		tx_fsm_counter_idle <= tx_fsm_counter_idle_clockdomainsrenamer0_next_value3;
	end
	if (tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce4) begin
		tx_fsm_encoder_ready <= tx_fsm_encoder_ready_clockdomainsrenamer0_next_value4;
	end
	if (tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce5) begin
		tx_fsm_fifo_ready <= tx_fsm_fifo_ready_clockdomainsrenamer0_next_value5;
	end
	if (tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce6) begin
		tx_fsm_strobe_crc <= tx_fsm_strobe_crc_clockdomainsrenamer0_next_value6;
	end
	if (tx_fsm_eop_clockdomainsrenamer0_next_value_ce7) begin
		tx_fsm_eop <= tx_fsm_eop_clockdomainsrenamer0_next_value7;
	end
	if (tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce8) begin
		tx_fsm_reset_crc <= tx_fsm_reset_crc_clockdomainsrenamer0_next_value8;
	end
