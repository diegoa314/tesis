//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (690de79) on 2020-06-28 16:43:48
//--------------------------------------------------------------------------------
module top(
	input write_clk_p,
	input write_clk_n,
...
wire [2:0] memory_wrport1_adr;
wire [31:0] memory_wrport1_dat_r;
wire [2:0] memory_wrport2_adr;
...
reg tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 = 1'd0;
reg tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 = 1'd0;
reg tx_fsm_sop_clockdomainsrenamer0_next_value1 = 1'd0;
reg tx_fsm_sop_clockdomainsrenamer0_next_value_ce1 = 1'd0;
reg tx_fsm_idle_clockdomainsrenamer0_next_value2 = 1'd0;
reg tx_fsm_idle_clockdomainsrenamer0_next_value_ce2 = 1'd0;
reg tx_fsm_change_disp_clockdomainsrenamer0_next_value3 = 1'd0;
reg tx_fsm_change_disp_clockdomainsrenamer0_next_value_ce3 = 1'd0;
reg [1:0] tx_fsm_counter_idle_clockdomainsrenamer0_next_value4 = 2'd0;
reg tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce4 = 1'd0;
reg tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5 = 1'd0;
reg tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce5 = 1'd0;
reg tx_fsm_fifo_ready_clockdomainsrenamer0_next_value6 = 1'd0;
reg tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce6 = 1'd0;
reg tx_fsm_strobe_crc_clockdomainsrenamer0_next_value7 = 1'd0;
reg tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce7 = 1'd0;
reg tx_fsm_eop_clockdomainsrenamer0_next_value8 = 1'd0;
reg tx_fsm_eop_clockdomainsrenamer0_next_value_ce8 = 1'd0;
reg tx_fsm_reset_crc_clockdomainsrenamer0_next_value9 = 1'd0;
reg tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce9 = 1'd0;
...
always @(*) begin
	tx_fsm_sop_clockdomainsrenamer0_next_value1 <= 1'd0;
	tx_fsm_fifo_ready_clockdomainsrenamer0_next_value6 <= 1'd0;
	tx_fsm_sop_clockdomainsrenamer0_next_value_ce1 <= 1'd0;
	tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce6 <= 1'd0;
	tx_fsm_idle_clockdomainsrenamer0_next_value2 <= 1'd0;
	tx_fsm_idle_clockdomainsrenamer0_next_value_ce2 <= 1'd0;
	tx_fsm_strobe_crc_clockdomainsrenamer0_next_value7 <= 1'd0;
	tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce7 <= 1'd0;
	tx_fsm_change_disp_clockdomainsrenamer0_next_value3 <= 1'd0;
	tx_fsm_change_disp_clockdomainsrenamer0_next_value_ce3 <= 1'd0;
	tx_fsm_counter_idle_clockdomainsrenamer0_next_value4 <= 2'd0;
	tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce4 <= 1'd0;
	tx_fsm_eop_clockdomainsrenamer0_next_value8 <= 1'd0;
	tx_fsm_eop_clockdomainsrenamer0_next_value_ce8 <= 1'd0;
	tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5 <= 1'd0;
	tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce5 <= 1'd0;
	tx_fsm_reset_crc_clockdomainsrenamer0_next_value9 <= 1'd0;
	tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce9 <= 1'd0;
	tx_next_state <= 3'd0;
	tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd0;
	tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd0;
	tx_next_state <= tx_state;
	case (tx_state)
		1'd1: begin
			if (tx_fsm_link_ready) begin
				if (tx_fsm_fifo_empty) begin
					tx_fsm_counter_idle_clockdomainsrenamer0_next_value4 <= (tx_fsm_counter_idle + 1'd1);
					tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce4 <= 1'd1;
					if ((tx_fsm_counter_idle == 2'd2)) begin
						tx_next_state <= 2'd2;
						tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5 <= 1'd1;
						tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce5 <= 1'd1;
					end else begin
						tx_next_state <= 1'd1;
					end
				end else begin
					tx_next_state <= 2'd3;
					tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd1;
					tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
					tx_fsm_sop_clockdomainsrenamer0_next_value1 <= 1'd1;
					tx_fsm_sop_clockdomainsrenamer0_next_value_ce1 <= 1'd1;
					tx_fsm_idle_clockdomainsrenamer0_next_value2 <= 1'd0;
					tx_fsm_idle_clockdomainsrenamer0_next_value_ce2 <= 1'd1;
				end
			end else begin
				tx_next_state <= 1'd0;
				tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5 <= 1'd0;
		...
		2'd3: begin
			...
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5 <= 1'd1;
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce5 <= 1'd1;
			tx_fsm_fifo_ready_clockdomainsrenamer0_next_value6 <= 1'd1;
			tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce6 <= 1'd1;
			tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd1;
			tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
			tx_fsm_sop_clockdomainsrenamer0_next_value1 <= 1'd0;
			tx_fsm_sop_clockdomainsrenamer0_next_value_ce1 <= 1'd1;
			tx_fsm_strobe_crc_clockdomainsrenamer0_next_value7 <= 1'd1;
			tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce7 <= 1'd1;
		end
		3'd4: begin
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5 <= 1'd1;
			tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce5 <= 1'd1;
			...
			if ((tx_fsm_data_type == 2'd2)) begin
				tx_fsm_eop_clockdomainsrenamer0_next_value8 <= 1'd1;
				tx_fsm_eop_clockdomainsrenamer0_next_value_ce8 <= 1'd1;
				tx_fsm_fifo_re_clockdomainsrenamer0_next_value0 <= 1'd0;
				tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0 <= 1'd1;
				tx_next_state <= 3'd5;
				tx_fsm_strobe_crc_clockdomainsrenamer0_next_value7 <= 1'd0;
				tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce7 <= 1'd1;
				tx_fsm_reset_crc_clockdomainsrenamer0_next_value9 <= 1'd1;
				tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce9 <= 1'd1;
			end
		end
		3'd5: begin
			tx_next_state <= 3'd6;
			tx_fsm_eop_clockdomainsrenamer0_next_value8 <= 1'd0;
			tx_fsm_eop_clockdomainsrenamer0_next_value_ce8 <= 1'd1;
			tx_fsm_idle_clockdomainsrenamer0_next_value2 <= 1'd1;
			tx_fsm_idle_clockdomainsrenamer0_next_value_ce2 <= 1'd1;
			tx_fsm_reset_crc_clockdomainsrenamer0_next_value9 <= 1'd0;
			tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce9 <= 1'd1;
		end
		...
		default: begin
			if ((tx_fsm_link_ready & tx_fsm_system_ready)) begin
				...
				tx_fsm_change_disp_clockdomainsrenamer0_next_value3 <= 1'd1;
				tx_fsm_change_disp_clockdomainsrenamer0_next_value_ce3 <= 1'd1;
			end else begin
				tx_next_state <= 1'd0;
			end
		end
...
always @(*) begin
	...
	case (fsm_state)
		1'd1: begin
			...
			if ((index == 4'd8)) begin
				index_clockdomainsrenamer3_next_value0 <= 4'd8;
				index_clockdomainsrenamer3_next_value_ce0 <= 1'd1;
				fsm_next_state <= 2'd2;
				write_fifo_clockdomainsrenamer3_next_value1 <= 1'd0;
...
always @(posedge tx_clk) begin
	...
	if ((((~tx_fsm_idle) & (~tx_fsm_eop)) & (~tx_fsm_sop))) begin
		tx_k0 <= 1'd0;
	end
	tx_k1 <= 1'd0;
	tx_k2 <= 1'd0;
	...
	if (tx_fsm_fifo_re_clockdomainsrenamer0_next_value_ce0) begin
		tx_fsm_fifo_re <= tx_fsm_fifo_re_clockdomainsrenamer0_next_value0;
	end
	if (tx_fsm_sop_clockdomainsrenamer0_next_value_ce1) begin
		tx_fsm_sop <= tx_fsm_sop_clockdomainsrenamer0_next_value1;
	end
	if (tx_fsm_idle_clockdomainsrenamer0_next_value_ce2) begin
		tx_fsm_idle <= tx_fsm_idle_clockdomainsrenamer0_next_value2;
	end
	if (tx_fsm_change_disp_clockdomainsrenamer0_next_value_ce3) begin
		tx_fsm_change_disp <= tx_fsm_change_disp_clockdomainsrenamer0_next_value3;
	end
	if (tx_fsm_counter_idle_clockdomainsrenamer0_next_value_ce4) begin
		tx_fsm_counter_idle <= tx_fsm_counter_idle_clockdomainsrenamer0_next_value4;
	end
	if (tx_fsm_encoder_ready_clockdomainsrenamer0_next_value_ce5) begin
		tx_fsm_encoder_ready <= tx_fsm_encoder_ready_clockdomainsrenamer0_next_value5;
	end
	if (tx_fsm_fifo_ready_clockdomainsrenamer0_next_value_ce6) begin
		tx_fsm_fifo_ready <= tx_fsm_fifo_ready_clockdomainsrenamer0_next_value6;
	end
	if (tx_fsm_strobe_crc_clockdomainsrenamer0_next_value_ce7) begin
		tx_fsm_strobe_crc <= tx_fsm_strobe_crc_clockdomainsrenamer0_next_value7;
	end
	if (tx_fsm_eop_clockdomainsrenamer0_next_value_ce8) begin
		tx_fsm_eop <= tx_fsm_eop_clockdomainsrenamer0_next_value8;
	end
	if (tx_fsm_reset_crc_clockdomainsrenamer0_next_value_ce9) begin
		tx_fsm_reset_crc <= tx_fsm_reset_crc_clockdomainsrenamer0_next_value9;
	end
