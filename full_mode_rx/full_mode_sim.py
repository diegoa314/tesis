...
class FullModeSim(Module):
    def __init__(self, platform):
        ...
        sys_clk_pads = platform.request("clk62_5")
        sys_clk=Signal() #gtp reference clk
        self.specials +=[
            Instance("IBUFG", i_I=sys_clk_pads, o_O=sys_clk)
        ]
        self.submodules.crg = CRG(sys_clk,rst=self.reset) #tx_init clock region
        ...
        platform.add_period_constraint(gtp.cd_tx.clk, 1e9/120e6)
        platform.add_period_constraint(gtp.cd_rx.clk, 1e9/120e6)
